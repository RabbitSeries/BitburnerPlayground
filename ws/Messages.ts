...
export type Response<T = undefined> = RequestNoParam & { result?: T, error?: object | string | number }
...
export type GetAllServersResponse = Response<{ hostname: string, hasAdminRights: boolean, purchaseByPlayer: boolean }[]>
